    ...
    return (
        <footer className='container max-w-2xl px-6 py-4 mx-auto'>
            <div className='flex flex-row justify-center items-center text-center gap-1'>Built with
                ...
                by
                <a href="https://github.com/Bhushan7344" target="_blank" className="cursor-pointer underline text-indigo-600 hover:text-indigo-500 font-normal" rel="noreferrer">Bhushan</a>
            </div>
        </footer>
    )
}
